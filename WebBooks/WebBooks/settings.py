...
# SECRET_KEY = 'django-insecure-_$50s95xs60+isbr6wwr9m=l#hg&h)zi(z@x@8-r5(p#$eikmx'
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'cg#p$g+j9tax!@a3cup@1$8obt2_+&k3q+pm)-r5(p#$eikmx')
