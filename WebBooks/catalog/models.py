...
class Book(models.Model):
    ...
    # Возвращает URL-адрес для доступа к определенному екземпляру книги.
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(
        max_length=20,
        null=True,
        help_text="Введите инвертарный номер",
    ...
    status = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        null=True,
        help_text="зменить состояние экземпляра",
        verbose_name="Статус экземпляра книги"
    )
    due_back = models.DateField(
        null=True,
        blank=True,
        help_text="Введите конец строка статуса",
